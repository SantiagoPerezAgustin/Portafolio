  ...
  const projects = [
    {
      ...
      tag: "E-commerce",
      description: "E-commerce full stack con autenticación, gestión de roles, paginación y documentación automática de API. Arquitectura limpia con Clean Architecture.",
    ...
    },
    {
      ...
      description: "App full stack con microservicios: OCR (Tesseract, PyPDF2), resumen y clasificación con Mistral, gestión de candidatos y recomendación de ofertas con Adzuna API.",
    ...
    },
    {
      ...
      tag: "Full Stack",
      description: "E-commerce full stack para emprendimiento familiar de calzado. Backend .NET 8 con API REST y arquitectura limpia, frontend React 19 con Vite, Tailwind y Context API.",
